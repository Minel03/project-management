            ...
            <div>
              ...
              <div className='relative'>
                ...
                <input
                  ...
                  className='w-full pl-9 pr-3 py-2 rounded-md bg-zinc-950 border border-zinc-700 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500 focus:outline-none text-sm text-zinc-200 placeholder-zinc-600 transition-colors'
                  required
                />
              </div>
            </div>
