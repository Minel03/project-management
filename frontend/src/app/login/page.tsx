...
export default function LoginPage() {
  ...
  const showDbControls = process.env.NEXT_PUBLIC_ENABLE_DB_INIT === 'true';
  ...
  return (
    <main className='min-h-screen bg-background text-foreground flex items-center justify-center px-4 transition-colors duration-200'>
      <div className='w-full max-w-sm space-y-5'>
        ...
        {/* DB Init Panel */}
        {showDbControls && (
          <div className='rounded-lg border border-border bg-card p-4 space-y-3 transition-colors'>
            ...
            <div className='flex gap-2'>
              <button
                ...
                className='flex-1 py-1.5 px-3 rounded-md text-xs font-medium bg-muted hover:bg-muted/80 border border-border text-foreground disabled:opacity-40 transition-colors flex items-center justify-center gap-1.5 cursor-pointer'>
                {isDbInitializing ? (
            ...
            {dbInitMessage && (
              <div
                className={`flex gap-2 p-2.5 rounded-md text-xs whitespace-pre-line border ${
                  dbInitType === 'success'
        ...
        <div className='rounded-lg border border-border bg-card p-5 space-y-4 transition-colors'>
          ...
          <form
            ...
            <button
              ...
              className='w-full py-2 px-4 rounded-md font-medium bg-indigo-600 hover:bg-indigo-500 text-white text-sm disabled:opacity-40 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-2 cursor-pointer focus:ring-2 focus:ring-indigo-500 focus:outline-none'>
              {isSubmitting ? (
                <>
